...
class ReflectionTest {
    ...
    void givenObject_whenGetsClassName_thenCorrect() {
        ...
        assertThat(clazz.getName()).isEqualTo(
                "reflection.Question"); // 클래스의 패키지 이름을 포함한 전체 경로 (내부 클래스의 경우 $ 기호를 사용하여 외부 클래스와 내부 클래스를 구분)
        assertThat(clazz.getCanonicalName()).isEqualTo(
                "reflection.Question"); // 클래스의 패키지 이름을 포함한 전체 경로 (내부 클래스의 경우 .을 사용하여 외부 클래스와 내부 클래스를 구분)
    }
