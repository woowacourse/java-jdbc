...
class PoolingVsNoPoolingTest {
    ...
    void noPoling() throws SQLException {
        ...
        // 테스트 결과를 확인한다.
        // no polling Elapsed runtime: 26s654ms513µs200ns
        log.info("no polling Elapsed runtime: {}", ClockSource.elapsedDisplayString(start, end));
    }
    ...
    void pooling() throws SQLException {
        ...
        // 테스트 결과를 확인한다.
        //polling Elapsed runtime: 4s534ms384µs100ns
        log.info("polling Elapsed runtime: {}", ClockSource.elapsedDisplayString(start, end));
    }
