...
class Stage0Test {
    ...
    void testChangePassword() {
        ...
        final var transactionHandler = new TransactionHandler(appUserService, platformTransactionManager);
        final var classLoader = this.getClass().getClassLoader();
        final UserService userService = (UserService) Proxy.newProxyInstance(classLoader, new Class[]{UserService.class}, transactionHandler);
