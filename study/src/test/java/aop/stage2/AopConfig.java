...
public class AopConfig {
    ...
    @Bean
    public TransactionAdvisor transactionAdvisor(TransactionPointcut pointcut, TransactionAdvice transactionAdvice) {
        return new TransactionAdvisor(pointcut, transactionAdvice);
    }
