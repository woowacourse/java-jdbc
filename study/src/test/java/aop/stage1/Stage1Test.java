...
class Stage1Test {
    ...
    void testChangePassword() {
        final UserService userService = getUserService(new UserService(userDao, userHistoryDao));
    ...
    void testTransactionRollback() {
        final UserService userService = getUserService(new UserService(userDao, stubUserHistoryDao));
    ...
    private UserService getUserService(final UserService targetService) {
