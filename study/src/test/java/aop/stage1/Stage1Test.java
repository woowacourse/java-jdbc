...
class Stage1Test {
    ...
    void testChangePassword() {
        final ProxyFactoryBean proxyFactoryBean = getProxyFactoryBean(new UserService(userDao, userHistoryDao));
    ...
    void testTransactionRollback() {
        final ProxyFactoryBean proxyFactoryBean = getProxyFactoryBean(new UserService(userDao, stubUserHistoryDao));
        final UserService userService = (UserService) proxyFactoryBean.getObject();
    ...
    private ProxyFactoryBean getProxyFactoryBean(UserService userService) {
