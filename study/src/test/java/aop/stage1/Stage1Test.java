...
class Stage1Test {
    ...
    void testChangePassword() {
        final ProxyFactoryBean proxyFactoryBean = createProxyFactoryBean(new UserService(userDao, userHistoryDao));
    ...
    void testTransactionRollback() {
        final ProxyFactoryBean proxyFactoryBean = createProxyFactoryBean(new UserService(userDao, stubUserHistoryDao));
        final UserService userService = (UserService) proxyFactoryBean.getObject();
    ...
    private ProxyFactoryBean createProxyFactoryBean(UserService target) {
