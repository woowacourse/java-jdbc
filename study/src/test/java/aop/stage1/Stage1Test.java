...
class Stage1Test {
    ...
    void testChangePassword() {
        final UserService userService = getProxyObject(new UserService(userDao, userHistoryDao));
    ...
    private UserService getProxyObject(UserService userService) {
    ...
    void testTransactionRollback() {
        final UserService userService = getProxyObject(new UserService(userDao, stubUserHistoryDao));
