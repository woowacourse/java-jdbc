...
class Stage1Test {
    ...
    void testChangePassword() {
        ProxyFactoryBean proxyFactoryBean = buildProxyFactoryBean(new UserService(userDao, userHistoryDao));
    ...
    void testTransactionRollback() {
        ProxyFactoryBean proxyFactoryBean = buildProxyFactoryBean(new UserService(userDao, stubUserHistoryDao));
        UserService userService = (UserService) proxyFactoryBean.getObject();
    ...
    private ProxyFactoryBean buildProxyFactoryBean(UserService target) {
