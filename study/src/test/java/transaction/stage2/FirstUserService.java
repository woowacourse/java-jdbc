...
public class FirstUserService {
    ...
    public Set<String> saveFirstTransactionWithRequired() {
        String firstTransactionName = TransactionSynchronizationManager.getCurrentTransactionName();
        userRepository.save(User.createTest());
        logActualTransactionActive();

        String secondTransactionName = secondUserService.saveSecondTransactionWithRequired();
    ...
    public Set<String> saveFirstTransactionWithSupports() {
        ...
        String secondTransactionName = secondUserService.saveSecondTransactionWithSupports();
    ...
    public Set<String> saveFirstTransactionWithNested() {
        ...
        String secondTransactionName = secondUserService.saveSecondTransactionWithNested();
