...
class Stage1Test {
     ...
     * Isolation level  |
     * -----------------|-------------
     * Read Uncommitted |   (+) user : isNotNull
     * Read Committed   |   (-) user : null
     * Repeatable Read  |   (-) user : null
     ...
     * Isolation level  |
     * -----------------|---------------------
     * Read Uncommitted |   (-) 실패 password : qqqq
     * Read Committed   |   (-) 실패 password : qqqq
     * Repeatable Read  |   (+) 성공 password : password
     * Serializable     |   (+) 성공 password : password
     */
    @Test
     ...
     * Isolation level  |
     * -----------------|--------------
     * Read Uncommitted |   (+) 실패 (size = 2)
     * Read Committed   |   (+) 실패 (size = 2)
     * Repeatable Read  |   (+) 실패 (size = 2)
     * Serializable     |   (-) 성공 (size = 1)
     */
    @Test
