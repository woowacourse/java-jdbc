 ...
 * Phantom reads Isolation level  |READ_COMMITTED|    REPEATBLE_READ   | SERIALIZABLE
 * -----------------|-------------|----------------------|-------------- Read Uncommitted |      +      |           +
...
class Stage1Test {
     ...
     * level  | READ_COMMITTED -----------------|------------- Read Uncommitted | + Read Committed   | - Repeatable Read
     * | - Serializable     | -
     */
    @Test
     ...
     * Isolation level  | REPEATABLE_READ -----------------|--------------------- Read Uncommitted | + Read Committed
     ...
     * Read phenomena | Phantom reads Isolation level  | SERIALIZABLE -----------------|-------------- Read Uncommitted
