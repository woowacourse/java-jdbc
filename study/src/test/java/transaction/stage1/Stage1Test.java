...
class Stage1Test {
     ...
     * Isolation level  |
     * -----------------|-------------
     * Read Uncommitted | + (DirtyReading 발생)
     * Read Committed   | - (DirtyReading 발생하지 않음)
     * Repeatable Read  | - (DirtyReading 발생하지 않음)
     * Serializable     | - (DirtyReading 발생하지 않음)
     */
    @Test
     ...
     * -----------------|---------------------
     * Read Uncommitted | +
     * Read Committed   | + // 해당 격리 레벨은 Read 에 관한 것들만 정리하는 듯하다.
     * Repeatable Read  | -
     * Serializable     | -
     */
    @Test
    ...
    void phantomReading() throws SQLException {
        ...
        // 초기 테이블 생성이 잘 될 수 있도록 추가적인 설정을 해준다.
