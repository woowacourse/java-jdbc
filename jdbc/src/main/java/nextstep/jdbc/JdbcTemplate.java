...
public class JdbcTemplate {
    ...
    public <T> List<T> query(final String sql, RowMapper<T> rowMapper, Object... params)  {
        ...
        return doExecute(sql, preparedStatement -> {
            ...
            int rowNum = 1;
            mappingRowToObjects(rowMapper, resultSet, objects, rowNum);

            return objects;
        });
    }

    private <T> void mappingRowToObjects(RowMapper<T> rowMapper, ResultSet resultSet, List<T> objects, int rowNum)
            throws SQLException {
