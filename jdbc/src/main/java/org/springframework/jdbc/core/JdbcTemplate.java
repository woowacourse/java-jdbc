...
public class JdbcTemplate {
    ...
    public <T> Optional<T> queryForObject(final String query, final RowMapper<T> rowMapper,
                                          final Object... columns) {
    ...
    private <T> List<T> execute(final String query, final RowMapper<T> rowMapper,
                                final Object[] columns) {
