...
public class JdbcTemplate {
    ...
    public Long updateAndReturnKey(final String sql, final Object... params) {
        return execute(sql, PreparedStatement.RETURN_GENERATED_KEYS, pstmt -> {
    ...
    private <T> T execute(final String sql, final int autoGeneratedKeys, final PreparedStatementCallBack<T> action) {
        try (final Connection conn = dataSource.getConnection();
