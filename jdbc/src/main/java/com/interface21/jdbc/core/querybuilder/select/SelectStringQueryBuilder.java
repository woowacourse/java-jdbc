...
public class SelectStringQueryBuilder<T> implements SelectSqlStep<T>, SelectExecutableStep<T> {
    ...
    public SelectStringQueryBuilder(JdbcTemplate jdbcTemplate, Class<T> mappedClass) {
