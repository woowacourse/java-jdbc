...
public class FakeResultSet implements ResultSet {
    ...
    public FakeResultSet(final List<List<Object>> rows) {
        this.rows = rows;
    }
    ...
    public boolean next() throws SQLException {
        rowCount++;
        return !rows.isEmpty() && !rows.get(rowCount).isEmpty();
    }
    ...
    public String getString(final int columnIndex) throws SQLException {
        return rows.get(rowCount).get(columnIndex - 1).toString();
    }
    ...
    public long getLong(final int columnIndex) throws SQLException {
        final String data = rows.get(rowCount).get(columnIndex - 1).toString();
