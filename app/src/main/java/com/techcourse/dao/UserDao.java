...
public class UserDao {
    ...
    public void insert(final User user) {
        ...
        jdbcTemplate.updateWithConnection(sql, user.getAccount(), user.getPassword(), user.getEmail());
    }
    ...
    public void update(final User user) {
        ...
        jdbcTemplate.updateWithConnection(sql, user.getAccount(), user.getPassword(), user.getEmail(), user.getId());
    }
