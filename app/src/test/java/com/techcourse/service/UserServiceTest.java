...
class UserServiceTest {
    ...
    void testChangePassword() {
        ...
        final var userService = new ProgrammaticUserService(userDao, userHistoryDao);
    ...
    @Test
    void testTransactionRollbackWithWrapping() {
        // 트랜잭션 롤백 테스트를 위해 mock으로 교체
        final var userHistoryDao = new MockUserHistoryDao(jdbcTemplate);
        // 애플리케이션 서비스
        ...
        final var userService = new TxWrappingUserService(transactionManager, appUserService);
    ...
    void testTransactional() {
        ...
        UserService userService = processor.createProxy(DeclarativeUserService.class, userDao, userHistoryDao);
