...
class UserServiceTest {
    ...
    void testChangePassword() {
        ...
        final var userService3 = new AppUserService(userDao, userHistoryDao);

        final var newPassword = "qqqqq";
        final var createBy = "gugu";
        userService3.changePassword(1L, newPassword, createBy);

        final var actual = userService3.findById(1L).get();
