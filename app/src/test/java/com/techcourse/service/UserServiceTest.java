...
class UserServiceTest {
    ...
    void setUp() {
        ...
        this.transactionTemplate = new TransactionTemplate(instance);
    ...
    void testChangePassword() {
        ...
        final var userService = new TxUserService(new AppUserService(userDao, userHistoryDao), transactionTemplate);
